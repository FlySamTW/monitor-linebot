...
## 2026-06-20 (v29.5.239-v29.5.268 SOP 路由、Prompt Sheet 同步與 PDF 索引防護)
...
- `v29.5.268` 已完成本機驗證；待刪除舊 Apps Script 版本後，需用 `deploy.bat` / `tools\deploy_existing_webhook.ps1` 推送 HEAD、建立新版本並更新既有 Deployment。
...
- Apps Script API `projects.getContent` 已確認遠端 HEAD 為 `v29.5.268 [2026-06-20 05:14]`，且不含「升級付費方案 / AI 暫時無法處理您的請求」舊文案。
- 沒有新建 GAS 部署。
...
- `tools/check_deploy_readiness.ps1` 實測輸出：本機 `v29.5.268`、遠端 HEAD `v29.5.268`、壞 API 文案 `False`、正式 health `v29.5.263`、版本數 `200`，並提示刪舊版本後重跑 `deploy.bat`。
