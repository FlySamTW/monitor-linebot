# Samsung LINE Bot 完整流程解析 (v29.6.215)

## 2026-08-20 (v29.6.215 / 精準區隔 FM5 無陀螺儀與 M8/M9 旋轉直式投影)

1. **FM5 無陀螺儀/固定底座硬體事實**：在 `buildDeterministicExactRuleReply_` 與 `QA.csv` 中精確載明 FM5 (M50F) 原廠底座為固定式且「無內建陀螺儀」，投影時直立手機兩側留黑邊，螢幕本身無法隨實體旋轉自動轉向；若需畫面隨實體旋轉滿版需選購具備陀螺儀與 HAS 旋轉支架的 M8/M9。
