# Samsung LINE Bot 完整流程解析 (v29.6.212)

## 2026-08-20 (v29.6.212 / 完善歷代 Smart Monitor M5 AirPlay 確鑿問答區隔)

1. **歷代 M5 (DM5/CM5/BM5/AM5) 與 FM5 AirPlay 確鑿判定**：DM5 (2024 款 M50D)、CM5、BM5、AM5 判定為「支援 Apple AirPlay 2」；FM5 (2026 款 M50F) 判定為「無原生支援 Apple AirPlay 2」並提供外接線材建議。
