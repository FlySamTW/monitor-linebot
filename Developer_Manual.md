# Samsung LINE Bot 完整流程解析 (v29.6.210)

## 2026-08-20 (v29.6.210 / 強化 M50F 與 M7/M8/M9 AirPlay 確鑿問答，並優化廣域搜尋與全球繁中解答)

1. **M50F AirPlay 確鑿問答防護**：在 `buildDeterministicExactRuleReply_` 中加入 Apple AirPlay 投影專屬規則。針對 M50F (`S27FM500EC`, `S27FM501EC`, `S32FM500EC`, `S32FM501EC`) 明確標示「無原生支援 Apple AirPlay 2」，提供外接線材與 Apple TV 建議；針對 M7/M8/M9 標示支援 AirPlay 2 並給出操作方式。
