...
- 生產模型仍固定 `models/gemini-2.5-flash-lite`；2026-08-15 官方 Standard 價格為 input US$0.10/M、output US$0.40/M。Gemini 3.5 Flash-Lite 雖改善文件理解，但 input US$0.30/M、output US$2.50/M；本題已由精準片段以 NT$0 正確解決，所以不測、不換 3.5。
