...
- 手冊 `countTokens` 的 20K 改為成本警戒而非拒絕線；先刪除無關歷史，只保留本輪完整問題。100K 為單次硬上限（依 2.5 Flash-Lite Standard input US$0.10/M 與匯率 32，純輸入最壞約 NT$0.32），並繼續受每題一份、每日 5 次、明確授權限制。
